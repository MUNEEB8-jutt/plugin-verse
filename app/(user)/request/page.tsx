    ...
    if (submitted) {
        return (
            <div className="min-h-screen bg-slate-900">
                <Navbar user={user} isAdmin={user?.user_metadata?.role === 'admin'} />
                            ...
                            <div className="grid grid-cols-3 gap-3">
                                {[
                                    ...
                                    <button
                                        ...
                                        className={`p-4 rounded-xl border text-center transition-all ${requestType === type.value
                            ...
                            <div className="flex flex-wrap gap-2">
                                {mcVersions.map((version) => (
                                    <button
                                        ...
                                        className={`px-4 py-2 rounded-lg border text-sm transition-all ${formData.minecraft_versions.includes(version)
                                            ? 'bg-emerald-500/20 border-emerald-500/50 text-emerald-400'
                                            : 'bg-slate-800 border-slate-600 text-slate-400 hover:bg-slate-700'
                                            }`}
                                    >
